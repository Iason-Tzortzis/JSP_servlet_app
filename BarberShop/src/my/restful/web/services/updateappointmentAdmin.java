...
@Path("UpdateappointmentAdmin")


public class updateappointmentAdmin {
	...
	@GET
	@Path("/update_appointment_admin/{date}/{haircut}/{time}/{appointmentID}/{price}")
	@Produces(MediaType.TEXT_PLAIN)
	
	public String update_appointment(@PathParam("date") String date, @PathParam("haircut") String haircut , @PathParam("time") String time, @PathParam("appointmentID") int appointmentID,@PathParam("price") String price) {
