...
@Path("Deleteappointment_Admin")
public class deleteAppointments_Admin {
	...
	@GET
	@Path("/delete_Appointment_Admin/{appointmentID}")
	@Produces(MediaType.TEXT_PLAIN)
	
	public String delete_appointment_Admin(@PathParam("appointmentID") int appointmentID) {
